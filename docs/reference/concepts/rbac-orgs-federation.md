<!-- Core document reconciled through SAGE v11.16.1, including app-v23 roles, Access Groups, Root continuity, linked federated readers, and the quorum/state-sync/governance-gateway sections. -->
