...
(`internal/abci/app.go:4806-4814`), which decodes ONLY the `outcome_class` field and
...
the early return in `armContentValidatorsFromProvider` (`app.go:2054-2075`)
leaves a pre-wired registry untouched.
