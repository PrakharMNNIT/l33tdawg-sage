...
test('release-facing version metadata stays aligned', () => {
  ...
  const exact = [
    ...
    ['docs/UPGRADING.md', `| v${version} | Consensus-authoritative pending-plan and active-ballot inspection`],
    ...
    ['deploy/federation-acceptance/docker-compose.yml', 'name: sage-v111902-federation'],
