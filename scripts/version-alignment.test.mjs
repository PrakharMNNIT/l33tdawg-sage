...
test('release-facing version metadata stays aligned', () => {
  ...
  const exact = [
    ...
    ['docs/UPGRADING.md', `| v${version} | The normal updater performs the canonical compatibility check itself`],
    ...
    ['deploy/federation-acceptance/docker-compose.yml', 'name: sage-v111903-federation'],
